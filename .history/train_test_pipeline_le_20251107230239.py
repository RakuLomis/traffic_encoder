...
if __name__ == '__main__':
    ...
    if USE_FLOW_FEATURES_THIS_RUN:
        ...
        try:
            ...
            print(f"!!! 致命错误: 无法加载源CSV文件 '{SOURCE_CSV_PATH}'. {e}")
            exit()
        ...
        # 【!! 核心修复 2 !!】 修正 calculate_flow_stats 函数
        ...
        global_true_maps = calculate_flow_stats(stats_df, is_train_set=False) # is_train_set=False
        ...
        for df_name, df in [('Train', train_df), ('Validation', val_df_aligned), ('Test', test_df_aligned)]:
            ...
            # 2. 应用“完美”的地图 (现在 f_name 会匹配 global_true_maps 中的键)
        ...
        for df in [train_df, val_df_aligned, test_df_aligned]:
            ...
            # (ip.len_temp_dec 和 time_temp_dec 不在 stats_df 上，已删除)
