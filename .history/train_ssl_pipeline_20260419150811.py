...
if __name__ == "__main__":
    ...
    SSL_PARA_EXP_PATH = os.path.join('CipherSpectrum', '0417')
    ...
    if PRETRAIN_CKPT_PATH and os.path.exists(PRETRAIN_CKPT_PATH):
        model.load_state_dict(
            torch.load(PRETRAIN_CKPT_PATH, map_location=DEVICE),
        ...
        if os.path.exists(best_ckpt_path):
            ...
            model.load_state_dict(torch.load(fallback_ckpt, map_location=DEVICE))
