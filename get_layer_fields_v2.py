...
python get_layer_field_v2.py -d "directory_path"
"""
...
def main(): 
    parser = argparse.ArgumentParser(description="Process pcap files in a specified directory to generate CSVs.")
    # Add the arguments
    parser.add_argument(
        '-d', '--directory', # short term and long term
        type=str, 
        required=True, 
    ...
    print(f"Starting to process pcap files in: {directory_path}") 
